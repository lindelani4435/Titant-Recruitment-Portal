...
//Contacts
Route::get('/registerUser',[CandidateController::class,'register']);
Route::post('/register-user', [CandidateController::class,'registerUser'])->name
('register-user');
...
Route::get('login/jobseeker/{provider}', [LoginController::class,'redirectToProvider']);



Route::get('login/jobseeker/{provider}/callback', [LoginController::class,'handleProviderCallback']);



Route::get('login/employer/{provider}', [App\Http\Controllers\Company\Auth\LoginController::class,'redirectToProvider']);



Route::get('login/employer/{provider}/callback',[App\Http\Controllers\Company\Auth\LoginController::class,'handleProviderCallback']);
