...
{{--                           <a href="{{ url('login/jobseeker/twitter')}}" class="tw"><i class="fab fa-twitter" aria-hidden="true"></i></a>--}}
                           <a href="{{ url('login/jobseeker/google')}}" class="tw"><i class="fab fa-google" aria-hidden="true"></i></a>
                           <a href="{{ url('login/jobseeker/linkedin')}}" class="tw"><i class="fab fa-linkedin" aria-hidden="true"></i></a>
                       </div>
...
{{--                           <a href="{{ url('login/employer/twitter')}}" class="tw"><i class="fab fa-twitter" aria-hidden="true"></i></a>--}}
                           <a href="{{ url('login/employer/google')}}" class="tw"><i class="fab fa-google" aria-hidden="true"></i></a>
                           <a href="{{ url('login/employer/linkedin')}}" class="tw"><i class="fab fa-linkedin" aria-hidden="true"></i></a>
                       </div>
