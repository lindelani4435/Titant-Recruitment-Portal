...
{{--                    <li><a href="{{ route('contact.us') }}">{{__('Contact Us')}}</a></li>--}}
            ...
            <div class="col-md-3 col-sm-12">
                <h5>{{__('Contact Us')}}</h5>
                <div class="address"><a style="color: white" href="https://goo.gl/maps/DEk6kerktu4TbNxY8">{{ $siteSetting->site_street_address }}</a></div>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="{{url('/')}}https://jaspa.co.za/" target="_blank">Jaspa</a></div>
            </div>
{{--            <div class="col-md-4">--}}
